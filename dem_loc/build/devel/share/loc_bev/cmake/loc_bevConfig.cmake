...
if(loc_bev_CONFIG_INCLUDED)
  return()
endif()
set(loc_bev_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(loc_bev_SOURCE_PREFIX /home/hsw/catkin_ws/program/dem_loc)
  set(loc_bev_DEVEL_PREFIX /home/hsw/catkin_ws/program/dem_loc/build/devel)
  set(loc_bev_INSTALL_PREFIX "")
  set(loc_bev_PREFIX ${loc_bev_DEVEL_PREFIX})
else()
  set(loc_bev_SOURCE_PREFIX "")
  set(loc_bev_DEVEL_PREFIX "")
  set(loc_bev_INSTALL_PREFIX /usr/local)
  set(loc_bev_PREFIX ${loc_bev_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'loc_bev' is deprecated")
...
set(loc_bev_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/local/include/opencv4;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/gdal " STREQUAL " ")
  set(loc_bev_INCLUDE_DIRS "")
  set(_include_dirs "/usr/local/include/opencv4;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2;/usr/include/gdal")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND loc_bev_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND loc_bev_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hsw/catkin_ws/program/dem_loc/build/devel/lib;/home/hsw/catkin_ws/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(loc_bev_LIBRARY_DIRS ${lib_path})
      list(APPEND loc_bev_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'loc_bev'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND loc_bev_LIBRARIES ${lib})
    endif()
  endif()
...
set(loc_bev_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${loc_bev_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;sensor_msgs;nav_msgs;cv_bridge;image_transport;pcl_ros;pcl_conversions;tf2;tf2_ros;tf2_geometry_msgs;tf2_eigen")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 loc_bev_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${loc_bev_dep}_FOUND)
      find_package(${loc_bev_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${loc_bev_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(loc_bev_INCLUDE_DIRS ${${loc_bev_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(loc_bev_LIBRARIES ${loc_bev_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${loc_bev_dep}_LIBRARIES})
  _list_append_deduplicate(loc_bev_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(loc_bev_LIBRARIES ${loc_bev_LIBRARIES})

  _list_append_unique(loc_bev_LIBRARY_DIRS ${${loc_bev_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(loc_bev_EXPORTED_TARGETS ${${loc_bev_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${loc_bev_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
